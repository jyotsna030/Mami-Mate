...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'select_roles',
          path: '/selectRoles',
          builder: (context, params) => SelectRolesWidget(),
        ),
        FFRoute(
          name: 'hospital_verify',
          path: '/hospitalVerify',
          builder: (context, params) => HospitalVerifyWidget(),
        ),
        FFRoute(
          name: 'hospital_dashboard',
          path: '/hospitalDashboard',
          builder: (context, params) => HospitalDashboardWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => SymptomsCheckerWidget(),
        ),
        FFRoute(
          name: 'chat_bot',
          path: '/chatBot',
        ...
        FFRoute(
          name: 'partner_collab',
          path: '/partnerCollab',
          builder: (context, params) => PartnerCollabWidget(),
        ),
        FFRoute(
          name: 'chat_screenCopy',
          path: '/chatScreenCopy',
          builder: (context, params) => ChatScreenCopyWidget(),
        )
